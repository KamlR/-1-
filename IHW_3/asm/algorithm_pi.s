...
algorithm_pi:
	...
	pxor	xmm0, xmm0
	movsd	QWORD PTR -16[rbp], xmm0 # на стек положили sqr_two
	movsd	xmm0, QWORD PTR .LC1[rip]
...
.L3:
	...
	movq	rax, xmm0 
	mov	QWORD PTR -16[rbp], rax # положили в sqr_two новый результат
	movsd	xmm0, QWORD PTR -16[rbp]
	movsd	xmm1, QWORD PTR .LC3[rip]
	divsd	xmm0, xmm1 # делим sqr_two/2
	movsd	QWORD PTR -48[rbp], xmm0 # результат деления помещаем на стек, denominator
	movsd	xmm0, QWORD PTR -24[rbp] 
	mulsd	xmm0, QWORD PTR -48[rbp] # перемножение denominator*not_result
