...
generate_choice:
	...
	mov	DWORD PTR -4[rbp], 0 # на стек сохранили кол-во гласных, сейчас 0
	...
	mov	edx, eax
	lea	eax, 1[rdx]
	mov	DWORD PTR -20[rbp], eax # на стек записали длину строки
...
.L2:
	mov	eax, DWORD PTR -12[rbp]
	cmp	eax, DWORD PTR -20[rbp] # сравнение счётчика цикла с длиной строки
...
.L7:
	...
	add	DWORD PTR -4[rbp], 1 # кол-во гласных на 1 увеличили
.L5:
	mov	eax, DWORD PTR -16[rbp]
	...
	add	DWORD PTR -8[rbp], 1 # кол-во согласных на 1 увеличили
.L6:
