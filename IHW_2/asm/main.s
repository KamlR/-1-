...
main:
	...
	mov	DWORD PTR -4[rbp], edi # из регистра edi на стек по адресу rbp[-4] поместили argc (кол-во передаваемых значений в main)
	mov	QWORD PTR -16[rbp], rsi # из rsi на стек по адресу rbp[-16] char *argv[] (данные для функции)
	cmp	DWORD PTR -4[rbp], 1 # сравнение argc с 1
...
.L2:
	cmp	DWORD PTR -4[rbp], 2 # сравнение argc с 2
...
.L4:
	cmp	DWORD PTR -4[rbp], 3 # сравнение argc с 3
